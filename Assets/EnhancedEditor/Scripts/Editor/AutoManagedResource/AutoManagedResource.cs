...
namespace EnhancedEditor.Editor
{
	...
	public class AutoManagedResource<T> where T : ScriptableObject
    {
        ...
        /// <summary>
        /// The default directory where all of this type resource assets are created.
        /// </summary>
        public string DefaultDirectory
        {
            get
            {
                ...
                string _value = EnhancedEditorPreferences.Preferences.AutoManagedResourceDefaultDirectory;
                if (IsEditorOnly)
                {
        ...
        public T CreateResource(string _name, T _resource)
        {
            ...
            string _directory = Path.Combine(Application.dataPath, DefaultDirectory);
            if (!Directory.Exists(_directory))
                Directory.CreateDirectory(_directory);

            string _path = Path.Combine(AssetsFolder, DefaultDirectory, $"{_name}.asset");
